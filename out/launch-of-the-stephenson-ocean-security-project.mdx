...
excerpt: >-
  ...
  Senator Sheldon Whitehouse (D-RI) provided keynote remarks. The event featured
  expert panels that explored the intersection of fisheries and security risk in
  the South China Sea and the challenge and opportunity presented by marine
  resources in the new Arctic Ocean.
authors: []
lede: >-
  The Stephenson Ocean Security Project launched Wednesday, January 9, 2019.
  Senator Sheldon Whitehouse (D-RI) provided keynote remarks.
keywords:
  - Event
further_reading: ''
related_commentary:
